...
module EXE_reg (
    ...
    input  wire [                31:0] ID_ALU_operand1,
    input  wire [                31:0] ID_ALU_operand2,
    ...
    output reg  [                31:0] EXE_ALU_operand1,
    output reg  [                31:0] EXE_ALU_operand2,
    ...
    always @(posedge clk) begin
        if (reset) begin
            EXE_valid                <= 1'b0;
            EXE_PC                   <= 32'h0;
            EXE_ALU_operand1         <= 32'b0;
            EXE_ALU_operand2         <= 32'b0;
            ...
            if (ID_to_EXE_valid & EXE_ready) begin
                EXE_PC                   <= ID_PC;
                EXE_ALU_operand1         <= ID_ALU_operand1;
                EXE_ALU_operand2         <= ID_ALU_operand2;
